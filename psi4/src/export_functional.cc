...
void export_functional(py::module &m) {
    ...
    py::class_<SuperFunctional, std::shared_ptr<SuperFunctional>>(m, "SuperFunctional", "docstring")
        ...
        .def("x_omega", &SuperFunctional::x_omega, "Range-separated exchange parameter.")
        .def("c_omega", &SuperFunctional::c_omega, "Range-separated correlation parameter.")
        ...
        .def("is_x_lrc", &SuperFunctional::is_x_lrc, "Contains range-separated exchange?")
        .def("is_c_lrc", &SuperFunctional::is_c_lrc, "Contains range-separated correlation?")
        ...
        .def("set_x_omega", &SuperFunctional::set_x_omega, "Sets the range-separation exchange parameter.")
        .def("set_c_omega", &SuperFunctional::set_c_omega, "Sets the range-separation correlation parameter.")
