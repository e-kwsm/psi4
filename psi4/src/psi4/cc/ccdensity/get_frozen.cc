...
void get_frozen() {
    ...
    psio_read_entry(PSIF_CC_INFO, "All Occ Orbs Per Irrep", (char *)frozen.occpi, sizeof(int) * moinfo.nirreps);
    psio_read_entry(PSIF_CC_INFO, "All Virt Orbs Per Irrep", (char *)frozen.virtpi, sizeof(int) * moinfo.nirreps);
    ...
    psio_read_entry(PSIF_CC_INFO, "CC->QT All Occ Order", (char *)frozen.qt_occ, sizeof(int) * moinfo.nmo);
    psio_read_entry(PSIF_CC_INFO, "CC->QT All Virt Order", (char *)frozen.qt_vir, sizeof(int) * moinfo.nmo);
    psio_read_entry(PSIF_CC_INFO, "QT->CC All Occ Order", (char *)frozen.allcc_occ, sizeof(int) * moinfo.nmo);
    psio_read_entry(PSIF_CC_INFO, "QT->CC All Virt Order", (char *)frozen.allcc_vir, sizeof(int) * moinfo.nmo);
    ...
    psio_read_entry(PSIF_CC_INFO, "All Virt Orb Offsets", (char *)frozen.vir_off, sizeof(int) * moinfo.nirreps);
    ...
    psio_read_entry(PSIF_CC_INFO, "All Occ Orbital Boolean", (char *)frozen.occ, sizeof(int) * moinfo.nmo);
    psio_read_entry(PSIF_CC_INFO, "All Virt Orbital Boolean", (char *)frozen.vir, sizeof(int) * moinfo.nmo);
    psio_read_entry(PSIF_CC_INFO, "All Socc Orbital Boolean", (char *)frozen.socc, sizeof(int) * moinfo.nmo);
}
