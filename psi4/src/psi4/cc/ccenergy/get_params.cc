...
void CCEnergyWavefunction::get_params(Options &options) {
    ...
    if (junk == "RHF")
        params_.ref = 0;
                                ...
                                params_.wfn == "CC3" || params_.wfn == "EOM_CC3" || params_.wfn == "CC2" ||
                                params_.wfn == "EOM_CC2" || params_.wfn == "BCCD" || params_.wfn == "BCCD_T")) {
        params_.ref = 2;
    ...
    if (params_.brueckner) outfile->Printf("    Brueckner conv. =     %3.1e\n", params_.bconv);
