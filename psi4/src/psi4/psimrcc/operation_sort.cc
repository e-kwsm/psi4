    ...
    if (assignment == "=" || assignment == ">=") {
        for (int h = 0; h < wfn_->nirrep(); ++h) {
            ...
            if (block_size > 0) {
                ...
                for (size_t i = 0; i < block_size; i++) A_block[i] = 0.0;
            }
        }
    }
                ...
                for (int n = 0; n < wfn_->nirrep(); n++) {
                    for (size_t i = 0; i < A_left_pairpi[n]; i++) {
                        ...
                        for (size_t j = 0; j < A_right_pairpi[n]; j++) {
                            ...
                            b_right = T_right_three_index_to_tuple[pqrs[reindexing_array[1]]][pqrs[reindexing_array[2]]]
                ...
                for (int n = 0; n < wfn_->nirrep(); n++) {
                    for (size_t i = 0; i < A_left_pairpi[n]; i++) {
                        ...
                        for (size_t j = 0; j < A_right_pairpi[n]; j++) {
                            ...
                            b_left = T_left_three_index_to_tuple[pqrs[reindexing_array[0]]][pqrs[reindexing_array[1]]]
                ...
                for (int n = 0; n < wfn_->nirrep(); n++) {
                    for (size_t i = 0; i < A_left_pairpi[n]; i++) {
                        ...
                        for (size_t j = 0; j < A_right_pairpi[n]; j++) {
                            ...
                            b_irrep =
                                T_left_three_index_to_irrep[pqrstu[reindexing_array[0]]][pqrstu[reindexing_array[1]]]
                                                           [pqrstu[reindexing_array[2]]];

                            b_left =
                                T_left_three_index_to_tuple[pqrstu[reindexing_array[0]]][pqrstu[reindexing_array[1]]]
                                                           [pqrstu[reindexing_array[2]]];

                            b_right =
                                T_right_three_index_to_tuple[pqrstu[reindexing_array[3]]][pqrstu[reindexing_array[4]]]
