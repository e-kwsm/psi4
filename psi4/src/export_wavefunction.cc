...
void export_wavefunction(py::module& m) {
    ...
    py::class_<scf::HF, std::shared_ptr<scf::HF>, Wavefunction>(m, "HF", "docstring")
        ...
        .def("cphf_Hx", &scf::HF::cphf_Hx, "CPHF Hessian-vector products (4 * J - K - K.T).")
        ...
        .def_property("reset_occ_", &scf::HF::reset_occ, &scf::HF::set_reset_occ,
                      "Do reset the occupation after the guess to the initial occupation.")
    ...
    py::class_<fisapt::FISAPT, std::shared_ptr<fisapt::FISAPT>>(m, "FISAPT", "A Fragment-SAPT Wavefunction")
        ...
        .def("scalars", &fisapt::FISAPT::scalars, "Return the internally computed scalars (not copied).")
        .def("vectors", &fisapt::FISAPT::vectors, "Return the internally computed vectors (not copied).")
        .def("matrices", &fisapt::FISAPT::matrices, "Return the internally computed matrices (not copied).")
