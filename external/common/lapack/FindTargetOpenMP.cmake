            ...
            if(WIN32)
                ...
                if(CMAKE_${_lang}_COMPILER_ID STREQUAL Clang)
                    ...
                    elseif(${_lang} STREQUAL CXX)
                        ...
                        message(FATAL_ERROR "clang-cl (MSVC compatibility wrapper) does not support ${_lang}")
                    endif()
                    if(NOT USE_CLANG_CL_${_lang})
                        message(FATAL_ERROR "clang-cl (MSVC compatibility wrapper) is required, if Clang is used")
                    endif()
                else()
